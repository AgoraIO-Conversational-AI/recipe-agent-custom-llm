# -*- coding: utf-8 -*-
"""
Agora Agent & Token Service — Audio Modalities Recipe

HTTP APIs:
- GET  /get_config     -> Generate connection config
- POST /startAgent     -> Start agent with Audio Modalities
...
# FastAPI application
app = FastAPI(
    title="Agora Audio Modalities Recipe Service",
    version="1.0.0",
    description="Agora Conversational AI with Audio Modalities output",
)
...
def _generate_channel_name() -> str:
    return f"audio-mod-{int(time.time())}-{random.randint(1000, 9999)}"
